...
You can quickly bootstrap an SSR React app with After.js using Dazzle. While Dazzle is not required, this documentation assumes you have the tooling setup for an isomorphic React application.
...
import { renderStatic } from 'after';
...
import { AfterRoot, AfterData, AfterScripts } from 'after';
...
- Jared Palmer [@jaredpalmer](https://twitter.com/jaredpalmer) (original author)
- Rahul Ranjan (rahul.ranjan@blitzscale.co) (rewrote for react 18+, react router v6, and dazzle)
