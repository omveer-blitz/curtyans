...
import { Route, matchPath, useNavigationType, useLocation, useParams, Routes, Navigate } from 'react-router-dom';
  ...
  return /*#__PURE__*/function (_React$Component) {
    function AsyncRouteComponent() {
      ...
      _this.updateState = function () {
        ...
        if (_this.state.Component !== Component$1) {
          _this.setState({
            Component: Component$1
          });
        }
    ...
    AsyncRouteComponent.load = function load() {
      return loader().then(function (ResolvedComponent) {
        Component$1 = ResolvedComponent["default"] || ResolvedComponent;
      });
    };
    ...
    AsyncRouteComponent.getInitialProps = function getInitialProps(ctx) {
      ...
      if (Component$1 !== null) {
        return Component$1.getInitialProps ? Component$1.getInitialProps(ctx) : Promise.resolve(null);
      }
    };
    ...
    _proto.render = function render() {
      ...
      if (ComponentFromState) {
        return createElement(ComponentFromState, Object.assign({}, this.props));
      }
      if (Placeholder) {
        return createElement(Placeholder, Object.assign({}, this.props));
      }
      return null;
    };
...
var __AfterContext = /*#__PURE__*/React__default.createContext({});
var useAfterContext = function useAfterContext() {
  return React__default.useContext(__AfterContext);
};
...
var Document = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return createElement("html", Object.assign({}, htmlAttrs), createElement("head", null, createElement("meta", {
    ...
    }), helmet.title.toComponent(), helmet.meta.toComponent(), helmet.link.toComponent(), createElement(AfterStyles, null)), createElement("body", Object.assign({}, bodyAttrs), createElement(AfterRoot, null), createElement(AfterData, null), createElement(AfterScripts, null)));
  };
  return Document;
}(Component);
...
var AfterStyles = function AfterStyles() {
  ...
  return createElement(Fragment, null, assets.client.css && createElement("link", {
    rel: "stylesheet",
...
var AfterScripts = function AfterScripts() {
  ...
  return createElement(Fragment, null, scripts.filter(isJS).map(function (path) {
    return createElement("script", {
      key: path,
      defer: true,
  ...
  }), assets.client.js && createElement("script", {
    type: "text/javascript",
...
var SerializeData = function SerializeData(_ref) {
  ...
  return React__default.createElement("script", Object.assign({
    defer: true
  }, props, {
    dangerouslySetInnerHTML: {
...
var After = function After(props) {
  ...
  var updateState = React__default.useCallback(function (data) {
    if (!!data) {
  ...
  var refetch = React__default.useCallback(function () {
  ...
  return React__default.createElement(Routes, {
  ...
  }, (initialData == null ? void 0 : initialData.statusCode) === 404 && React__default.createElement(Route, {
    Component: NotfoundComponent,
    path: currentLocation.pathname
  }), (initialData == null ? void 0 : initialData.redirectTo) && React__default.createElement(Navigate, {
    ...
    return React__default.createElement(Route, {
      path: route.path,
      key: "route--" + index,
      element: React__default.createElement(Component, Object.assign({}, initialData, {
        match: match,
        location: currentLocation,
...
var __AfterRouterContext = /*#__PURE__*/React__default.createContext({});
var useAfterRouterContext = function useAfterRouterContext() {
  return React__default.useContext(__AfterRouterContext);
};
...
var modPageFn = function modPageFn(Page) {
  return function RenderAfter(props) {
    //@ts-ignore
    return createElement(Page, Object.assign({}, props));
  };
};
/**
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
              ...
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    asyncOrSyncRender = renderer(createElement(__AfterRouterContext.Provider, {
                      value: context
        ...
        case 31:
          ...
          doc = renderToStaticMarkup(createElement(__AfterContext.Provider, {
            value: props
          }, createElement(Doc, Object.assign({}, props))));
...
export { After, AfterData, AfterRoot, AfterScripts, AfterStyles, Document, SerializeData, __AfterContext, __AfterRouterContext, asyncComponent, ensureReady, errorMeesage, getAssets, getSerializedData, loadInitialProps, render, renderApp, renderStatic, useAfterContext, useAfterRouterContext };
//# sourceMappingURL=after.esm.js.map
